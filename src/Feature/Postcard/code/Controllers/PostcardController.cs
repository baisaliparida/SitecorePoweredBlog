    ...
    public class PostcardController : Controller
    {
        ...
        public ActionResult Postcard()
        {
            ...
            try
            {
                ...
                Sitecore.Data.Items.Item[] allItems = database.SelectItems(@"fast:/sitecore/content/SitecorePoweredBlog/Article//*[@@templateid='{E1F2D433-B9FE-4684-B987-2D0E270A53C7}']");
